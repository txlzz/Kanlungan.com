<?php
	...
	$showUsersSql = $conn->prepare ("Select * from users where status='Needs Evacuation Support'");
...
<br>
			<nav class="navtop">
<div> <h1> Household Disaster Monitoring </h1> </div>
<br>
...
<table class="admin_seg">
				...
				<tbody>
					<tr>
						...
						<td><a href="delete.php?id=<?= $usersList['id'] ?>">Tagged Safe</a></td>
					</tr>
				</tbody>
			 <?php endforeach; ?>
			 </table>
